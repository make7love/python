...
def pull_mysql_data(htid , mysql_lock):
	...
	pull_command = "ping -c 3 -w 10 www.baidu.com"
...
def pull_weedfs_data(htid , weedfs_lock):
	...
	#pull_command= "touch %s/%s_%s" % (pull_weedfs_data_dir , htid , "weedfs")
	pull_command = "cd %s ; wget www.baidu.com" % (pull_weedfs_data_dir)
	ret = execute_command(pull_command)
